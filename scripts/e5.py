...
import re
import sys
sys.path.append('/home/sense/gpt2')
import time
...
with open('/home/sense/gpt2/scripts/keywords.txt', 'r', encoding='utf-8')as file:
        ...
        for i in range(args.samples):
            ...
            if len(file_dict) >= 100:
                for k, v in file_dict.items():
                    with open(f'/home/sense/gpt2/article/{k}.txt','a', encoding='utf-8')as f:
                        f.write(f'{v}\n')
#            print("\n".join(l))
                file_dict.clear()
